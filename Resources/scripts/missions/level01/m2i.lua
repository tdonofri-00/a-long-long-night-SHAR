Game.SelectMission("m2")
	...
	Game.AddStage()
		...
		Game.AddObjective("goto")
			...
			Game.AddStageVehicle("cNerd","m2_nerdrace","NULL","Missions\\level01\\m3_2ndNORM.con","male2")
		Game.CloseObjective()
		if Mode.IsNormal then
	...
	Game.AddStage()
		...
		Game.AddToCountdownSequence( "o", 150 )
		Game.AddObjective("timer")
	...
	Game.AddStage()
		...
		Game.ActivateVehicle("cNerd","NULL","race")
		Game.AddStageWaypoint( "m2_raceend" )
		Game.AddObjective( "goto")
			Game.SetDestination("m2_raceendB","carsphere")
