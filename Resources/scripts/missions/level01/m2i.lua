...
Game.SelectMission("m2")
	...
	Game.StreetRacePropsUnload("m2_cops.p3d:")	--  Cop Props.
	...
	if GetSetting("ScrapBookMode") then
		Game.AddStage(0)
			...
			Game.AddStageVehicle("cNerd","m2_nerd_preview","NULL","Missions\\level01\\M2nerd.con","male2")
	...
	Game.AddStage(0)
		...
		Game.AddObjective("goto")
			Game.SetDestination("m2_hotel","upwardglow")
		Game.CloseObjective()
	...
	Game.AddStage(0)
		...
		DisableAllCameras()
		Game.ResetStageHitAndRun()
		Game.AddStageVehicle("cLimo","m2_limo_remove","target","Missions\\level01\\M2limo.con")	--if it's NULL, it won't despawn. thanks radical.
		Game.AddStageVehicle("cNerd","m2_nerdrace","NULL","Missions\\level01\\M2nerd.con","male2")
		Game.AddStageCharacter("bart", "", "", "current", "m2_racestart_cops")	--move player to enable cop props.
		Game.AddObjective("timer")
			Game.RemoveDriver("mobstr")
	...
	Game.AddStage(0)
		...
		Game.NoTrafficForStage()
		DisableAllCameras()
		Game.AddStageVehicle("cLimo2","m2_limo_chase1","NULL","Missions\\level01\\M2limo.con","mobstr")
		Game.AddStageVehicle("cNerd","m2_nerd_chase1","NULL","Missions\\level01\\M2nerd.con","male2")
	...
	Game.AddStage(0)
		...
		Game.AddObjective( "goto")
			...
			Game.AddNPC("earhart","m2_crowd_npc4")
			Game.SetDestination("m2_police_interrupt","upwardglow")
	...
	Game.AddStage(0) -- AAAAAAAAAAA CINEMATICS
		...
		Game.AddStageVehicle("cLimo2","m2_limo_escape","NULL","Missions\\level01\\M2limo.con","mobstr")	--hide
	...
	Game.AddStage(0)
		...
		Game.DisableHitAndRun()
		Game.AddStageVehicle("cLimo2","m2_limo_escape","NULL","Missions\\level01\\M2limo.con","mobstr")
		...
		Game.AddObjective("goto")
			...
			Game.AddNPC("wiggum","m2_crowd_npc3")
			Game.AddNPC("earhart","m2_crowd_npc4")
			Game.SetDestination("m2_escape","upwardglow")
			Game.SetCollectibleEffect("none")
	...
	--but what if the player uses the secret vehicle?
	--[[
	Game.AddStage(0)
		DisableAllCameras()
		Game.DisableTrigger("Z1p2")
		Game.DisableHitAndRun()
		Game.SetHUDIcon("w_fone")
		...
		Game.AddCondition("insidetrigger")
			...
			Game.SetCondThreshold(2.5)
			Game.SetCondMessageIndex(9)
			Game.SetCondDecay(40, 2)
			Game.SetCondSound("spotted_alert","enter_trigger")
			Game.SetCondSound("hidden_alert","exit_trigger")
		Game.CloseCondition()
		Game.AddCondition("insidetrigger")
			Game.SetCondTrigger("m2_limo_fail")
		Game.CloseCondition()
		Game.AddStageTime(4)
		Game.AddCondition("timeout")
		Game.CloseCondition()
	...
	Game.AddStage(0)
		...
		Game.AddObjective("goto")
			Game.TurnGotoDialogOff()
			Game.SetDestination("m2_stadium", "upwardglow")
		Game.CloseObjective()
		SetTimeByDifficulty(25, 20)
		Game.AddCondition("timeout")
		Game.CloseCondition()
		Game.AddCondition("insidetrigger")
			Game.SetCondTrigger("m2_crowd1")
		...
		Game.CloseCondition()
		Game.SetIrisWipe(0.1)
		Game.SetCompletionDialog("angryarrive")
	Game.CloseStage()
	...
	Game.AddStage()
		...
		Game.AddStageVehicle("cLimo2","m2_limo_after_escape","evade","Missions\\level01\\M2limo.con","mobstr")
	...
	Game.AddStage()
		Game.CHECKPOINT_HERE()	-- i don't think anyone wants to do the running segment again and again
		Game.SetCheckpointDynaLoadData("l5r1.p3d;l5z1.p3d;l5r4.p3d;m2_cops.p3d;")
		Game.SetCheckpointResetPlayerInCar("m2_bart_after_wait")
		Game.DisableHitAndRun()
		DisableAllCameras()
		Game.SetHUDIcon("w_alley")
		Game.SetStageMessageIndex(14)
		Game.AddStageCharacter("bart", "", "", "current", "m2_bart_after_wait")
		Game.AddStageVehicle("cLimo2","m2_limo_after_wait","chase","Missions\\level01\\M2limo.con","mobstr")
		...
		Game.AddObjective("goto")
			...
			Game.AddNPC("pol_sell","m2_crowd_npc1")	--hide police station lou. he'll respawn back at station after mission is over and player is far away enough.
			Game.SetDestination("m2_alley", "upwardglow")
		Game.CloseObjective()
		SetTimeByDifficulty(30, 20)
		Game.AddCondition("timeout")
		Game.CloseCondition()
		...
		Game.StageStartMusicEvent("M2_start")
		Game.SetIrisWipe(0.1)
		Game.SetCompletionDialog("angryleave")
	Game.CloseStage()
	...
	Game.AddStage()
		...
		Game.AddStageVehicle("cLimo2","m2_limo_near_alley","evade","Missions\\level01\\M2limo.con","mobstr")
		...
		Game.AddObjective("timer")
			Game.AddNPC("krusty", "m2_krusty")
			Game.AddNPC("pol_sell","m2_crowd_npc1")
	...
	Game.AddStage()
		Game.CHECKPOINT_HERE()
		Game.SetCheckpointDynaLoadData("l5r3.p3d;l5z4.p3d;l5r4.p3d;m2_cops.p3d;")
		...
		Game.AddObjective("goto")
			...
			Game.SetDestination("m2_kb_police_nerd", "upwardglow")
		Game.CloseObjective()
		Game.AddCondition("insidetrigger")
			Game.SetCondTrigger("m2_crowd1")
			Game.SetCondSound("spotted_alert","enter_trigger")
	...
	Game.AddStage()
		...
		Game.AddCondition("outsidetrigger")
			Game.SetCondTrigger("m2_arena")
			Game.SetCondThreshold(10)
			Game.SetCondDecay(20, 2)
			Game.SetCondMessageIndex(19)
			Game.SetCondDisplay("none")
			Game.SetCondSound("krusty_alert", "exit_trigger")
			Game.SetCondSound("krusty_alert_off", "enter_trigger")
		Game.CloseCondition()
	...
	Game.AddStage()
		...
		Game.AddObjective("goto")
			...
			Game.AddNPC("pol_sell","m2_crowd_npc1")
			Game.SetDestination("m2_kb_police", "upwardglow")
		Game.CloseObjective()
		Game.AddCondition("insidetrigger")
			Game.SetCondTrigger("m2_crowd1")
			Game.SetCondSound("spotted_alert","enter_trigger")
